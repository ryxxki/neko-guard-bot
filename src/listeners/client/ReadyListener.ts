...
export default class ReadyListener extends Listener{
    ...
    public exec():void{
        ...
        this.client.guilds.cache.forEach(async e => {
            ...
            const msg = `I have been updated by the owner. Previous settings such as language and prefix commands are reset when updated ... `
            //`Restart Server. Previous settings such as language and prefix commands has been resetting `//when updated ... `
